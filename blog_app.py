...
#GROQ_API_KEY = input("Please enter your GROQ API Key here: "os.getenv("GROQ_API_KEY"))
GROQ_API_KEY = st.text_input("Please enter your GROQ API Key here: ", value=os.getenv("GROQ_API_KEY"),type="password")
# Configure Groq client
